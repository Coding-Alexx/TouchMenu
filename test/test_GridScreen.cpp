...
void test_if_elements_dont_overlap(){   //macht noch keinen sinn
    ...
    RoundButton* roundButton1 = new RoundButton ("", COLOR_RED,  "", COLOR_GREEN, COLOR_YELLOW, callbackTest);
    RoundButton* roundButton2 = new RoundButton ("", COLOR_RED,  "", COLOR_GREEN, COLOR_YELLOW, callbackTest);
