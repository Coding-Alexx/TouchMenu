...
RectButtonCircle::RectButtonCircle(const char* textOn, const Color& infillOn, const char* textOff, const Color& infillOff, const Color& border, const bool hasRoundedCorners, const button_func_ptr button_callback, bool* const value):
...
{}
RectButtonCircle::RectButtonCircle(const char* textOn, const Color& infillOn, const char* textOff, const Color& infillOff, const Color& borderOn, const Color& borderOff,const bool hasRoundedCorners, const button_func_ptr button_callback, bool* const value):
    Button(button_callback, value),
    colorInfillOn(infillOn),
    colorInfillOff(infillOff),
    ...
    hasRoundedCorners(hasRoundedCorners)
{}
RectButtonCircle::RectButtonCircle(const char* textOn, const Color& infillOn, const char* textOff, const Color& infillOff, const Color& border,const bool hasRoundedCorners,const switch_func_ptr switch_callback, bool* const value):
    ...
    hasRoundedCorners(hasRoundedCorners)
{}
RectButtonCircle::RectButtonCircle(const char* textOn, const Color& infillOn, const char* textOff, const Color& infillOff, const Color& borderOn, const Color& borderOff, const bool hasRoundedCorners, const switch_func_ptr switch_callback, bool* const value):
    Button(switch_callback, value),
    colorInfillOn(infillOn),
    colorInfillOff(infillOff),
    colorBorderOn(borderOn),
...
void RectButtonCircle::draw() {    
    ...
    const uint16_t circlePosY = posY + circleSize/2 +1;
